...
%-----------------------------------------------------------------------------%
\author{Robin Ladwig und Patrick Koch}
\newcommand{\daAutor}{Robin Ladwig und Patrick Koch}
% Matrikelnummern hier eintragen:
\newcommand{\daMatrikelnummerRobin}{Matrikelnummer Robin}
\newcommand{\daMatrikelnummerPatrick}{Matrikelnummer Patrick}
\newcommand{\daTitel}{Die Entwicklung des IT-Projektmanagements von klassischen linearen Ansätzen zu agilen Vorgehensmodellen -- Der Einfluss künstlicher Intelligenz auf gegenwärtige und zukünftige Projektpraktiken}
\newcommand{\daTitelEins}{Die Entwicklung des IT-Projektmanagements}
\newcommand{\daTitelZwei}{von klassischen linearen Ansätzen zu agilen Vorgehensmodellen}
\newcommand{\daTitelDrei}{Der Einfluss künstlicher Intelligenz auf gegenwärtige und zukünftige Projektpraktiken}
...
\newcommand{\daStudiengang}{Wirtschaftsinformatik (B.Sc.)}
\newcommand{\daStudienort}{Digitales Live-Studium (DLS)}

\newcommand{\daAutorAdresse}{Musterstraße 123}
\newcommand{\daAutorPLZ}{12345}
\newcommand{\daAutorOrt}{DLS}

\newcommand{\daDate}{Abgabedatum wird ergänzt}


\newcommand{\daGutachterEins}{M.Sc. Cihan Yilmaz}
